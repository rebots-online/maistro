...
class SheetMusicEvaluator:
    def __init__(self, model_path='runs/detect/sheet_music_detector_v11/weights/best.pt'):
        """Initialize the evaluator with a trained YOLOv11 model"""
        self.model = YOLO(model_path)
        logger.info(f"Loaded YOLOv11 model from {model_path}")
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate sheet music detection model')
    parser.add_argument('--model', type=str, 
                       default='runs/detect/sheet_music_detector_v11/weights/best.pt',
